...
module.exports = (env) =>{
    ...
    return {
        ...
        plugins: [
            CSSExtract,
            new webpack.DefinePlugin({ // This will create a webpack "variable" that can be referred to, thus allowing these keys to change based on the environment and not having expose files with keys?
